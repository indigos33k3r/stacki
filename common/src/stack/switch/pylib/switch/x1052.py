...
class SwitchDellX1052(Switch):
	...
	def upload_software(self, software_file):
		"""Uploads the provided firmware file to the switch.
	...
	def reload(self):
		...
		This will disconnect from the switch and connect will have to be called again once it reboots
		...
		# Now forcefully kill the process as we've hit one of the expected prompts, and the switch doesn't appear to
		# gracefully terminate the ssh session on reboot.
